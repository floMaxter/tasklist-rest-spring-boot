package com.projects.tasklist.repository.impl;
...
import com.projects.tasklist.repository.DataSourceConfig;
import com.projects.tasklist.repository.UserRepository;
import com.projects.tasklist.repository.mappers.UserRowMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    public void insertUserRole(Long userId, Role role) {
        try {
            ...
            throw new ResourceMappingException("Exception while inserting user's role.");
        }
    }
    ...
    public boolean isTaskOwner(Long userId, Long taskId) {
        try {
            ...
            throw new ResourceMappingException("Exception while checking user is task owner.");
        }
    }
