...
import com.projects.tasklist.repository.mappers.TaskRowMapper;
...
public class TaskRepositoryImpl implements TaskRepository {
    ...
    public List<Task> findAllByUserId(Long userId) {
        try {
            ...
            throw new ResourceMappingException("Exception while finding all tasks by user id.");
        }
    }
    ...
    public void assignToUserById(Long taskId, Long userId) {
        try {
            ...
            throw new ResourceMappingException("Exception while assigning user.");
        }
    }
